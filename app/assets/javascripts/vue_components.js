...
// special Vue component for criminals which has 5 tabs (there has to be a better way to do this??)
Vue.component('tabs', {
  // note how a lot of the messiness of the tabs markup is moved out to the component
  template: `
    <div>
      <div class="row">
          <div class="col s12">
            <ul class="tabs">
              <li class="tab col s4 five" v-for="tab in tabs">
                <a v-bind:href="tab.href" v-bind:class="{ 'active': tab.isActive }" v-on:click="selectTab(tab)">{{ tab.name }}</a>
              </li>
            </ul>
          </div>
  ...
  template: `
    <div>
      <div class="row">
          <div class="col s12">
            <ul class="tabs">
              <li class="tab col s4 three" v-for="tab in tabs">
                <a v-bind:href="tab.href" v-bind:class="{ 'active': tab.isActive }" v-on:click="selectTab(tab)">{{ tab.name }}</a>
              </li>
            </ul>
          </div>
